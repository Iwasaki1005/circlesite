...
$site_top = "https://neverland-f.com/";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "alex7dw@gmail.com,info@neverland-f.com";
...
$thanksPage = "https://neverland-f.com/fin";
...
$refrom_name = "ねばーランド.F";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問合せを受け付けました";
...
お問い合わせありがとうございました。
返信が必要な場合は内容を確認次第ご返信致しますので今しばらくお待ちください。
