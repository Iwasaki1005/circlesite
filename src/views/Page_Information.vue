			...
			<v-tabs-items v-model="tab">
				<v-tab-item>
					<div class="NW-container">
						<p class="info-indexbg m-bottom-1rem co-white">プライバシーポリシー</p>
						<p>
							※googleのやつをコピペ
						</p>
					</div>
				...
				<v-tab-item>
					<div class="NW-container">
						<p class="info-indexbg m-bottom-1rem co-white">当サイトへのリンクについて</p>
						<p>
							当サイトは基本的にリンクフリーです。<br>
							リンクをしていただく際のURLはトップページへお願いします。<br><br>
							サイトへリンクされる際にバナーをご使用される場合につきましてはこちらで用意したバナーをお使いください。<br>
						</p>
						<p class="info-indexbg m-bottom-1rem co-white m-top-2rem">バナー</p>
						<p class="">
				...
				<v-tab-item>
					<div class="NW-container">
						<p class="info-indexbg m-bottom-1rem co-white">閲覧推奨ブラウザ</p>
						<p class="m-bottom-1rem">当サイトを閲覧する際の推奨ブラウザは下記のものになります。</p>
						<p class="m-bottom-1rem">
							・Google Chrome
						</p>
						<p class="fs-0_8rem co-grey">
